...
def on_update(delta_time):
    ...
    if ball_y > HEIGHT - 10 and asds:
        delta_y *= -1
    elif ball_y < 10 or (player_x - 15 < ball_x < player_x + 15 and player_y - 15 < ball_y < player_y + 15) and asds:
        delta_y = 0
        delta_x = 0
        asds = False
       
    if not((ball_y - player_y < 40) and (player_x-32 < ball_x < player_x + 32)):
        asds = True
